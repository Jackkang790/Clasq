...
```text
422AD77374A3EDB70D5133FCF18A14C00CB9213E155A181B50444E2328A6F004
```
...
- Undo 후 빈 폴더가 삭제되지 않는 문제 수정
- 자동정리 Preview에서 이미 정리된 파일(충돌)이 불필요한 폴더 카드를 생성하는 문제 수정
- 저장 목록 삭제 버튼 열 너비 및 헤더 레이블 개선
- 이력 다이얼로그 Undo 버튼 및 파일 아이콘 카드 위아래 잘림 수정
